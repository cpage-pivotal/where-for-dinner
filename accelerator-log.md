...
```json
{
  ...
  "workloadNamespace" : "where-for-dinner",
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Wrote values file with json content:   {"artifactVersion":"0.0.1-beta","dynamicMsgBroker":false,"dbType":"h2","empty":"","nativeBuild":false,"enableSecurity":false,"gatewayType":"ossscg","includeBuildToolWrapper":true,"msgbrokerName":"msgbroker-where-for-dinner","numRabbitMQClusterNodes":1,"secureProfile":"secure","appWorkloadURL":"http://where-for-dinner.<UPDATE ME>","artifactId":"where-for-dinner","serviceNamespace":"service-instances","projectName":"where-for-dinner","workloadNamespace":"where-for-dinner","msgBrokerType":"rabbitmq","cacheType":"inmemCache","workloadType":"web","ployglotWorkloads":false}
┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Shelling out to YTT with args: [ytt, -f, /tmp/ytt-input3884424125693176916, --data-values-file, /tmp/accelerator-options2484693720025080163.json, --output-files, /tmp/ytt-output12772494929600749268]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Wrote values file with json content:   {"artifactVersion":"0.0.1-beta","dynamicMsgBroker":false,"dbType":"h2","empty":"","nativeBuild":false,"enableSecurity":false,"gatewayType":"ossscg","includeBuildToolWrapper":true,"msgbrokerName":"msgbroker-where-for-dinner","numRabbitMQClusterNodes":1,"secureProfile":"secure","appWorkloadURL":"http://where-for-dinner.<UPDATE ME>","artifactId":"where-for-dinner","serviceNamespace":"service-instances","projectName":"where-for-dinner","workloadNamespace":"where-for-dinner","msgBrokerType":"rabbitmq","cacheType":"inmemCache","workloadType":"web","ployglotWorkloads":false}
┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Shelling out to YTT with args: [ytt, -f, /tmp/ytt-input1487834777193339632, --data-values-file, /tmp/accelerator-options2537871011560076558.json, --output-files, /tmp/ytt-output1429566541775602680]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Wrote values file with json content:   {"artifactVersion":"0.0.1-beta","dynamicMsgBroker":false,"dbType":"h2","empty":"","nativeBuild":false,"enableSecurity":false,"gatewayType":"ossscg","includeBuildToolWrapper":true,"msgbrokerName":"msgbroker-where-for-dinner","numRabbitMQClusterNodes":1,"secureProfile":"secure","appWorkloadURL":"http://where-for-dinner.<UPDATE ME>","artifactId":"where-for-dinner","serviceNamespace":"service-instances","projectName":"where-for-dinner","workloadNamespace":"where-for-dinner","msgBrokerType":"rabbitmq","cacheType":"inmemCache","workloadType":"web","ployglotWorkloads":false}
┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Shelling out to YTT with args: [ytt, -f, /tmp/ytt-input4026595650246790128, --data-values-file, /tmp/accelerator-options8354676395898736018.json, --output-files, /tmp/ytt-output17502725209675111144]
